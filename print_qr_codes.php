...
<head>
    ...
    <title>Print QR Codes - <?php echo htmlspecialchars($data['product']['name']); ?></title>
...
<body>
    ...
    <div class="screen-only">
        ...
        <div class="preview-note">
            <strong>Print Preview:</strong> This page is optimized for printing. The QR codes will be arranged in a 3-column grid when printed.
        </div>
    </div>
    ...
    <div class="batch-info screen-only">
        ...
        <p><strong>Quantity:</strong> <?php echo (int)$data['quantity']; ?> QR codes</p>
    ...
    <div class="quantity-info screen-only">
        <strong>Note:</strong> Printing <?php echo (int)$data['quantity']; ?> identical QR codes for product: 
    ...
    <div class="qr-grid">
        <?php for ($i = 1; $i <= (int)$data['quantity']; $i++): ?>
            <div class="qr-item">
                <img src="data:image/png;base64,<?php echo $data['qr_image_base64']; ?>" 
                     alt="QR Code for <?php echo htmlspecialchars($data['product']['name']); ?>">
                ...
                <div class="product-info">
                    ...
                    <div class="product-details">
                        ...
                        <strong>QR:</strong> <?php echo htmlspecialchars($data['qr_content']); ?><br>
    ...
    <script>
        ...
        window.addEventListener('afterprint', function() {
            ...
            setTimeout(function() {
                if (confirm('QR codes printed successfully. Would you like to return to Stock In page?')) {
                    clearPrintData();
                }
            }, 1000);
        });
